...
try:
    # Get the memberships for the service principal
    memberships = graph_client.service_principals.list_member_groups(service_principal_object_id)
